      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        {items.length > 0 ? (
          <>
            ...
            {totalPages > 1 ? (
              <nav aria-label="Paginación" className="mt-12 flex items-center justify-center gap-1.5">
                {page > 1 ? (
                  <Link href={buildQuery({ q, cat, type, saga, status }, { page: String(page - 1) })} aria-label="Página anterior" className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 text-zinc-300 transition hover:border-ember-400 hover:text-ember-300">
                ...
                {page < totalPages ? (
                  <Link href={buildQuery({ q, cat, type, saga, status }, { page: String(page + 1) })} aria-label="Página siguiente" className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 text-zinc-300 transition hover:border-ember-400 hover:text-ember-300">
          ...
          <div className="rounded-2xl border border-dashed border-white/10 bg-ink-900 px-6 py-16 text-center">
            ...
            <Link href="/catalogo" className="mt-6 inline-flex rounded-xl border border-white/10 px-5 py-2.5 text-sm text-zinc-200 transition hover:border-ember-400 hover:text-ember-300">
