...
export default function WhatsAppButton({
  ...
  const base =
    "inline-flex items-center justify-center gap-2.5 rounded-xl px-6 py-3.5 font-semibold transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-ember-400";
  const styles =
    variant === "primary"
      ? "bg-ember-500 text-black hover:bg-ember-400 hover:shadow-ember active:scale-[0.98]"
      : "border border-white/15 text-white hover:border-ember-400 hover:text-ember-300";
